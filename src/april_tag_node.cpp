...
public:
    ...
    it_(nh) 
  {
    ...
    private_node_handle.param<double>("focal_length_x_px", camera_focal_length_x_px_, 700.0); // late 2013 macbookpro retina fx = 700
    private_node_handle.param<double>("focal_length_y_px", camera_focal_length_y_px_, 700.0);
    private_node_handle.param<double>("principal_point_x_px_", camera_principal_point_x_px_, 320.0); // 640x480 image = (320, 240) middle
    ...
    ROS_INFO_STREAM("got tag size (in meters) " << tag_size_m_);
